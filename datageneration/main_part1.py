...
def main():
    ...
    fshape[1] = np.array([ 2.25176191, -3.7883464 ,  0.46747496,  3.89178988,  2.20098416,  0.26102114, -3.07428093,  0.55708514, -3.94442258, -2.88552087]) #fat
    fshape[2] = np.array([-2.26781107,  0.88158132, -0.93788176, -0.23480508,  1.17088298,  1.55550789,  0.44383225,  0.37688275, -0.27983086,  1.77102953]) #thin
    fshape[3] = np.array([ 0.00404852,  0.8084637 ,  0.32332591, -1.33163664,  1.05008727,  1.60955275,  0.22372946, -0.10738459,  0.89456312, -1.22231216]) #short
    fshape[4] = np.array([ 3.63453289,  1.20836171,  3.15674431, -0.78646793, -1.93847355, -0.32129994, -0.97771656,  0.94531640,  0.52825811, -0.99324327]) #tall
    fshape[5] = np.array([-2.26781107,  5, -0.93788176, -0.23480508,  1.17088298,  1.55550789,  0.44383225,  0.37688275, -0.27983086,  1.77102953]) #really thin
    fshape[6] = np.array([-0.03440948, -0.4913598 , -0.76049036,  0.40780908,  0.15279156, -0.31704524,  0.633123  , -1.9430263 , -0.65972745, -0.8617339 ]) #shape_0
    fshape[7] = np.array([-1.3563803 ,  0.6747352 ,  0.96001345,  0.26044375,  1.2382318 ,0.44735488,  0.19571048,  1.7167183 , -3.0548346 , -1.3401744 ]) #shape_1
    fshape[8] = np.array([ 0.96752423, -0.06359129, -0.12249097, -0.6315959 ,  1.1843153 ,-1.2808145 , -0.7655795 ,  0.81283015, -0.5342422 ,  0.760295]) #shape_2
    fshape[9] = np.array([-0.3840254 ,  0.00182145, -1.3469802 ,  1.6455222 , -1.256669  , -1.224065  , -1.09989   , -0.53995615, -0.11464527, -0.5736639 ]) #shape_200
    fshape[10] = np.array ([ 1.4354341 ,  0.52111673,  0.1527621 , -0.147447  ,  0.0311013 ,-0.01738557,  0.15416093, -0.43654475, -1.2626901 , -0.22193913]) #shape_500
